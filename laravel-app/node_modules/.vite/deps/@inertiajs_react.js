...
function A(t, e = new FormData(), i = null) {
  t = t || {};
  for (let n in t) Object.prototype.hasOwnProperty.call(t, n) && J(e, X(i, n), t[n]);
  return e;
}
function X(t, e) {
  return t ? t + "[" + e + "]" : e;
...
function J(t, e, i) {
  if (Array.isArray(i)) return Array.from(i.keys()).forEach((n) => J(t, X(e, n.toString()), i[n]));
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b2 = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
    ...
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L2, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D2, onError: U, queryStringArrayFormat: F2, cancelToken: new AbortController() }, g({ cancel: () => {
      ...
      } else if (r.response) $(r.response) && z.show(r.response.data);
      ...
      if (!axios_default.isCancel(r)) {
        let s = H(r);
        if (this.activeVisit && this.finishVisit(this.activeVisit), s) return Promise.reject(r);
      }
    });
  }
  ...
  restore(e = "default") {
    var _a, _b;
    if (!_) return (_b = (_a = window.history.state) == null ? void 0 : _a.rememberedState) == null ? void 0 : _b[e];
  }
  on(e, i) {
    let n = (o) => {
      let c = i(o);
...
function se(t) {
  if (clearTimeout(Y), import_nprogress.default.isStarted()) t.detail.visit.completed ? import_nprogress.default.done() : t.detail.visit.interrupted ? import_nprogress.default.set(0) : t.detail.visit.cancelled && (import_nprogress.default.done(), import_nprogress.default.remove());
  else return;
}
function ae(t) {
...
var X2 = function({ children: l, title: c }) {
  ...
  function S(e) {
    let i = Object.keys(e.props).reduce((r, y) => {
      if (["head-key", "children", "dangerouslySetInnerHTML"].includes(y)) return r;
      let T = e.props[y];
      return T === "" ? r + ` ${y}` : r + ` ${y}="${T}"`;
    }, "");
    return `<${e.type}${i}>`;
...
function w2({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S }) {
  ...
  }, []), !d.component) return (0, import_react5.createElement)(A2.Provider, { value: u2 }, (0, import_react5.createElement)(E.Provider, { value: d.page }, null));
...
function W2(l, c) {
  ...
  let v2 = (0, import_react7.useCallback)((t, o, n = {}) => {
    let k2 = { ...n, onCancelToken: (m) => {
      if (d.current = m, n.onCancelToken) return n.onCancelToken(m);
    }, onBefore: (m) => {
      if (x2(false), R2(false), clearTimeout(P.current), n.onBefore) return n.onBefore(m);
    }, onStart: (m) => {
      if (T(true), n.onStart) return n.onStart(m);
    }, onProgress: (m) => {
      if (h(m), n.onProgress) return n.onProgress(m);
    }, onSuccess: (m) => {
      if (s.current && (T(false), h(null), e({}), r(false), x2(true), R2(true), P.current = setTimeout(() => {
        s.current && R2(false);
      }, 2e3)), n.onSuccess) return n.onSuccess(m);
    }, onError: (m) => {
      if (s.current && (T(false), h(null), e(m), r(true)), n.onError) return n.onError(m);
    }, onCancel: () => {
      if (s.current && (T(false), h(null)), n.onCancel) return n.onCancel();
    }, onFinish: () => {
      if (s.current && (T(false), h(null)), d.current = null, n.onFinish) return n.onFinish();
    } };
